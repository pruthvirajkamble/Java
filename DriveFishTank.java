class Fish {
    ...
    public void DisplayFish(){
        System.out.println("Types of Fish ": + species + " Color of the fish : "+ color +
            " Size in centimeters" + size + " True if freshwater fish : " + isFreshWater +
             " Age of the fish in year "+ age);
    }
}
class FishTank{
    ...
    public void DisplayFishTank(){
        System.out.println("Capacity of the tank in liters "+ capacity + " Material of the tank" + material
        " Shape of the tank"+ shape + " Type of filter used in the tank "+ filterType +
         " Number of fish in the tank "+ numOfFish);
    }
}
class Water {
    ...
    public void DisplayWater(){
        System.out.println("Water temperature in Celsius "+ temperature + " pH level of the water"+ pHLevel + 
        " True if freshwater "+ isFreshWater + " Water hardness level "+hardness+
        " Salinity level (for saltwater tanks) "+ salinity);
    }
 }
 class FishFood {
    ...
    public void DisplayFishFood(){
        ...
        System.out.println(" Quantity of food in grams"+ quantity);
        System.out.println(" Brand of the fish food"+ brand);
        System.out.println(" True if the food is organic"+ isOrganic);
        System.out.println(" Expiration date of the food"+ expirationDate);
    }
}
class Plant {
